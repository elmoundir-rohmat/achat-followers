# ARTICLE BLOG - INSTALLER SORA 2 EN FRANCE
## Format prêt à copier-coller dans Sanity
...
**Slug :**
```
installer-sora-2-france-tutoriel-complet
```

**Extrait / Description courte :**
```
Tutoriel complet pour installer Sora 2 en France via l'App Store, obtenir une invitation et utiliser Sora ChatGPT pour créer des vidéos IA.
```
...
```
Tutoriel pour installer Sora 2 en France
```

**Auteur :**
```
(Sélectionner "Équipe IA & Innovation" dans la liste)
```

**Catégorie :**
```
(Sélectionner "Tutoriel" dans la liste)
```
...
## 📝 CONTENU (Copier-coller dans le champ "Contenu")
...
**URL canonique :**
```
https://doctorfollowers.com/blogs/installer-sora-2-france-tutoriel-complet
```
...
1. **Ouvrir Sanity Studio** et créer un nouvel article de blog
2. **Remplir chaque champ** en copiant-collant les valeurs ci-dessus
3. **Pour le contenu :** Copier tout le bloc de contenu dans le champ "Contenu" - Sanity convertira automatiquement le Markdown en format riche
...
- L'auteur "Équipe IA & Innovation" doit exister dans Sanity avant de pouvoir le sélectionner
- La catégorie "Tutoriel" doit exister dans Sanity avant de pouvoir la sélectionner
...
- Le contenu Markdown sera automatiquement converti en format Portable Text par Sanity
