...
export default defineType({
  ...
  fields: [
    defineField({
      ...
      type: 'string',
      initialValue: 'Page Instagram Views',
      readOnly: true,
    }),
    ...
    defineField({
      ...
      initialValue: 'Acheter des vues Instagram',
    }),
    ...
    defineField({
      ...
      fields: [
        ...
        {
          name: 'whyBuy',
          title: 'Titre Section "Pourquoi acheter des vues..." (H2)',
          type: 'string',
        },
      ],
    }),
    ...
    defineField({
      name: 'viewTypes',
      title: 'Section "Types de Vues" - SEO',
      type: 'object',
      description: 'Contenu des sections "Vues Internationales" et "Vues Instagram Françaises"',
      fields: [
        {
          name: 'international',
          title: 'Vues Internationales',
          type: 'object',
          fields: [
            {
              name: 'title',
              title: 'Titre (H3)',
              type: 'string',
              initialValue: 'Vues Internationales',
            },
            {
              name: 'descriptions',
              ...
              type: 'array',
              of: [{ type: 'string' }],
              description: 'Les 3 descriptions de la section Vues Internationales',
            },
          ],
        },
        {
          name: 'french',
          title: 'Vues Instagram Françaises',
          type: 'object',
          fields: [
            {
              name: 'title',
              title: 'Titre (H3)',
              type: 'string',
              initialValue: 'Vues Instagram Françaises',
            },
            {
              name: 'descriptions',
              title: 'Descriptions (3 points)',
              type: 'array',
              of: [{ type: 'string' }],
              description: 'Les 3 descriptions de la section Vues Instagram Françaises',
            },
          ],
        },
      ],
    ...
    defineField({
      ...
      fields: [
          ...
          fields: [
            {
              ...
              title: 'Titre (H3)',
              type: 'string',
              initialValue: 'Maximiser la portée de vos reels',
            },
            {
              name: 'description',
        ...
        {
          name: 'visibilite',
          title: 'Améliorer votre visibilité organique',
          type: 'object',
          fields: [
            {
              name: 'title',
              title: 'Titre (H3)',
              type: 'string',
              initialValue: 'Améliorer votre visibilité organique',
            },
            {
              name: 'description',
              title: 'Description (Paragraphe)',
    ...
    defineField({
      ...
      fields: [
        ...
        },
        {
          ...
          title: 'URL Canonique',
          type: 'url',
          initialValue: 'https://doctorfollowers.com/products/acheter-des-vues-instagram',
        },
      ],
    }),
  ...
  preview: {
    ...
    prepare() {
      return {
        title: 'Page Instagram Views',
        subtitle: 'Contenu SEO de la page Instagram Views',
      }
    },
  },
})
