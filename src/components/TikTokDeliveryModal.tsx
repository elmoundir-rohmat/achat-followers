...
interface TikTokDeliveryModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function TikTokDeliveryModal({ 
  isOpen, 
  onClose, 
  onBack,
  onConfirm, 
  ...
  const deliveryOptions: DeliveryOption[] = [
    {
      ...
      description: 'Vous recevrez vos abonnés dans 10–15 minutes',
      runs: 1,
      interval: 0,
    ...
    },
    {
      ...
      description: 'Vous recevrez vos abonnés pendant 24 heures',
      runs: 12,
      interval: 120,
      totalTime: '24 heures',
    ...
    },
    {
      ...
      description: 'Vous recevrez vos abonnés pendant 3 jours',
      runs: 12,
      interval: 360,
      totalTime: '3 jours',
    ...
    },
    {
      ...
      description: 'Vous recevrez vos abonnés pendant 7 jours',
      runs: 21,
      interval: 480,
      totalTime: '7 jours',
    ...
    },
    {
      ...
      description: 'Vous recevrez vos abonnés pendant 14 jours',
      runs: 14,
      interval: 1440,
      totalTime: '14 jours',
      icon: <Clock className="w-5 h-5" />,
    ...
    },
    {
      ...
      description: 'Vous recevrez vos abonnés pendant 30 jours',
      runs: 30,
      interval: 1440,
      totalTime: '30 jours',
      icon: <Shield className="w-5 h-5" />,
  ...
  const calculateFollowersPerRun = (runs: number) => {
    return Math.ceil(followersCount / runs);
  };

  const calculateTotalFollowers = (runs: number) => {
    return followersCount * runs;
  };
      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-pink-600 to-purple-600 text-white p-6">
          ...
          <p className="text-pink-100 mt-2">
            {followersCount.toLocaleString()} followers TikTok {followerType === 'french' ? 'Français' : 'Internationaux'} sur {tiktokUrl}
          </p>
        </div>
