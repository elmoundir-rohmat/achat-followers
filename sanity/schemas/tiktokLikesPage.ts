...
export default defineType({
  ...
  fields: [
    defineField({
      ...
      type: 'string',
      initialValue: 'Page TikTok Likes',
      readOnly: true,
    }),
    ...
    defineField({
      ...
      initialValue: 'Acheter des likes TikTok',
    }),
    ...
    defineField({
      ...
      type: 'object',
      description: 'Contenu des sections "Likes Internationaux" et "Likes TikTok Français"',
      fields: [
        {
          name: 'international',
          ...
          fields: [
            {
              ...
              title: 'Titre (H3)',
              type: 'string',
              initialValue: 'Likes TikTok Français',
            },
            {
              name: 'descriptions',
              title: 'Descriptions (3 points)',
              type: 'array',
              of: [{ type: 'string' }],
              description: 'Les 3 descriptions de la section Likes TikTok Français',
            },
          ],
        },
      ],
    ...
    defineField({
      ...
      fields: [
        ...
        },
        {
          ...
          title: 'URL Canonique',
          type: 'url',
          initialValue: 'https://doctorfollowers.com/products/acheter-des-likes-tiktok',
        },
      ],
    }),
  ...
  preview: {
    ...
    prepare() {
      return {
        title: 'Page TikTok Likes',
        subtitle: 'Contenu SEO de la page TikTok Likes',
      }
    },
  },
})
