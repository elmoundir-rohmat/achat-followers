    ...
    <div className="min-h-screen bg-cream font-rounded">
      ...
      <main className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16">
        <FollowerTypeSelector
          ...
          title={pageData?.pageH1 || "Acheter des likes Instagram"}
          headingLevel="h1"
      ...
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-soft-pink-50 via-peach-50 to-lavender-50 py-20 md:py-28">
            ...
            <div className="relative">
              {pageData?.hero?.image?.url ? (
                <img 
                  ...
                  alt={pageData.hero.image.alt || "Instagram Likes and Engagement Analytics"} 
              ...
              <div>
                {pageData?.whyBuySection?.engagement?.image?.url ? (
                  <img 
                    ...
                    alt={pageData.whyBuySection.engagement.image.alt || "Instagram Post with High Likes and Engagement"} 
                    className="rounded-card shadow-soft-xl"
                  />
                ) : (
                  <img 
              ...
              <div className="order-first lg:order-none">
                {pageData?.whyBuySection?.portee?.image?.url ? (
                  <img 
                    ...
                    alt={pageData.whyBuySection.portee.image.alt || "Instagram Analytics Dashboard showing Reach and Impressions"} 
                    className="rounded-card shadow-soft-xl"
                  />
                ) : (
                  <img 
              ...
              <div>
                {pageData?.whyBuySection?.credibilite?.image?.url ? (
                  <img 
                    ...
                    alt={pageData.whyBuySection.credibilite.image.alt || "Instagram Business Profile with High Engagement Metrics"} 
                    className="rounded-card shadow-soft-xl"
                  />
                ) : (
                  <img 
