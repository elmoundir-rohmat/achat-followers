...
export default defineType({
  ...
  fields: [
    defineField({
      ...
      type: 'string',
      initialValue: 'Page Générateur de Bio Instagram',
      readOnly: true,
    }),
      ...
      fields: [
        {
          ...
          initialValue: 'Générateur de bio Instagram',
        },
        {
          name: 'description',
    ...
    defineField({
      ...
      fields: [
        ...
        },
        {
          ...
          title: 'URL Canonique',
          type: 'url',
          initialValue: 'https://doctorfollowers.com/generateur-bio-instagram',
        },
      ],
    }),
  ...
  preview: {
    ...
    prepare() {
      return {
        title: 'Page Générateur de Bio Instagram',
        subtitle: 'Contenu SEO de la page générateur de bio',
      }
    },
  },
})
