...
export default defineType({
  ...
  fields: [
    defineField({
      ...
      type: 'string',
      initialValue: 'Page TikTok Followers',
      readOnly: true,
    }),
    ...
    defineField({
      ...
      initialValue: 'Acheter des followers TikTok',
    }),
    ...
    defineField({
      ...
      type: 'object',
      description: 'Contenu des sections "Followers Internationaux" et "Abonnés TikTok Français"',
      fields: [
        {
          name: 'international',
          ...
          fields: [
            {
              ...
              title: 'Titre (H3)',
              type: 'string',
              initialValue: 'Abonnés TikTok Français',
            },
            {
              name: 'descriptions',
              title: 'Descriptions (3 points)',
              type: 'array',
              of: [{ type: 'string' }],
              description: 'Les 3 descriptions de la section Abonnés TikTok Français',
            },
          ],
        },
      ],
    ...
    defineField({
      ...
      fields: [
        ...
        {
          name: 'explorer',
          title: 'Apparaître dans l\'onglet "Pour vous"',
          type: 'object',
          fields: [
            {
              name: 'title',
              title: 'Titre (H3)',
              type: 'string',
              initialValue: 'Apparaître dans l\'onglet "Pour vous"',
            },
            {
              name: 'description',
              title: 'Description (Paragraphe)',
    ...
    defineField({
      ...
      fields: [
        ...
        },
        {
          ...
          title: 'URL Canonique',
          type: 'url',
          initialValue: 'https://doctorfollowers.com/products/acheter-followers-tiktok',
        },
      ],
    }),
  ...
  preview: {
    ...
    prepare() {
      return {
        title: 'Page TikTok Followers',
        subtitle: 'Contenu SEO de la page TikTok Followers',
      }
    },
  },
})
