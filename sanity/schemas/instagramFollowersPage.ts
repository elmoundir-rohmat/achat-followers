...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'string',
      description: 'H1 principal affiché au-dessus des packs (sélecteur).',
      initialValue: 'Acheter des followers Instagram',
    }),
      ...
      fields: [
        {
          ...
          type: 'string',
          description: 'Le titre du hero, désormais en H2',
        },
        {
          name: 'description',
